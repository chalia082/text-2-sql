  ...
  return ( 
    <div className="h-full relative">
      ...
      <div className={`container mx-auto relative flex flex-col xl:px-60 px-10 h-[calc(100%-72px)] ${isSubmitted ? 'overflow-x-auto' : 'justify-between pb-52'}`}>
        ...
        <div className={`fixed w-full xl:px-80 md:px-40 transition-all delay-150 duration-200 ease-in-out z-10 ${isSubmitted ? 'bottom-0 mb-8' : 'bottom-1/2'} ${expanded ? 'left-20' : ' left-0'}`}> <Input /> </div>
