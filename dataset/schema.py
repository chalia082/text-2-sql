...
def main():
    ...
    try:
        ...
        extractor.generate_llm_prompt_file('newdb.txt')
        extractor.save_schema_json('newdb.json')
        # extractor.save_schema_yaml('newdb.yaml')
        
        print("\nSchema extraction completed successfully!")
        print("Files generated:")
        print("- newdb.txt (optimized for LLM)")
        print("- newdb.json (structured data)")
        # print("- newdb.yaml (human-readable)")
